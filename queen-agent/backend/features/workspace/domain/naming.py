"""The rule shared by everything that puts a name somewhere it might already be.

Projects, chats and files all reach for it when a name is born, and the trash reaches for it when a
name is deleted twice. Two copies of this rule would drift apart on the first change to either.
"""
