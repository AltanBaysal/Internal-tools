...
GENERATE_PROMPTS_PLUS = (
    ...
    "craft. Fewer frames than sentences means work left: carry on from the first sentence with "
    "no frame.\n"
    "\n"
...
START_A_SCENARIO = (
    ...
    "background. Never stop the flow waiting for a description. When a step is approved, its "
