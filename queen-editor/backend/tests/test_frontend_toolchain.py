...
This file sits beside the backend's tests because `pytest queen-editor` collects them from here,
but what it examines is the frontend's manifest rather than a subsystem.
