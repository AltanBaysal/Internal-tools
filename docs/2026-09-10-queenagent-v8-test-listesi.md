...
**Kaynağı:** [yol haritası](superpowers/roadmaps/2026-09-06-queenagent-v8-roadmap.md) — yirmi beş madde,
...
- **Metin yanlış geliyorsa** — cümlenin bugünkü hâli
  ...
  olan koddur.
- **Bir madde neden böyle diye sorarsan** — [yol haritası](superpowers/roadmaps/2026-09-06-queenagent-v8-roadmap.md),
