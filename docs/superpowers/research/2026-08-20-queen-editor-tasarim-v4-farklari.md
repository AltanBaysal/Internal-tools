...
| 50 | **Fark 37 düşüyor — 13 Ağustos 2026 kararı geçerli** *(kullanıcı kararı, 21 Ağustos 2026)*. O karar bu durumu adıyla kapsıyor: *"Hiçbir üretim kullanıcı basmadan başlamaz. İstisnası yok — yarıda kalmış kuyruk da, üreticisini bekleyen kuyruk da bekler"*, ve farkın geri getirmek istediği *"Kurulum bitince kuyruk kendiliğinden sürer"* cümlesini de adıyla siliyor. Yani fark 36 ile aynı karar; 6. karar ikisini birden kapatıyor, notu yalnız 36'nın satırına düşmüş. Uygulamada değişen bir şey yok. | 37 |
