# QueenAgent — Yol Haritası v2 (KAPANDI)

**Branch:** `fix/mira` · **Tarih:** 2026-08-15 – 2026-08-18 · **Durum:** kapandı
**Sonrası:** [v4](2026-08-20-queen-agent-v4-roadmap.md)

> **İki koşu, tek belge.** Bu sürüm iki koşu taşıdı ve her koşu kendi yol haritasını açmıştı — o
> zamanki adlarıyla *"v2"* ve *"v3"*. 13 Eylül 2026'da birleştirildiler: bir sürüm bir daldır ve o
> dalın tek yol haritası olur, ikisi de `fix/mira`'da koşmuştu. Metinleri olduğu gibi aşağıda;
> değişen tek şey her koşunun kendi başlığı altına girmesi ve buraya gelen bağlantıların hangi koşuyu
> gösterdiklerini söylemesi. Madde numaraları zaten sürüyordu — Koşu 2 kendi ağzıyla *"numaralar
> v2'den devam eder"* diyor.
>
> **v3 numarası boş kaldı ve kaydırılmadı.** `feat/queenagent-v5`, `feat/queenagent-v7` ve
> `feat/queenagent-v8` numaralarını adlarının içinde taşıyor; aşağı kayan her belge kendi dalıyla
> çelişirdi. Açıklanmış bir boşluk, kaymış bir numaradan iyidir.

---

# Koşu 1 — 15 Ağustos *(o zamanki adıyla "v2")*

**Tarih:** 2026-08-15 · **Branch:** `fix/mira`
...
*(Bu başlık 13 Eylül'e kadar **"yazıldı, koşu bekliyor"** diyordu ve eskimişti: maddelerin spec ve
planları 16–18 Ağustos'ta `fix/mira`'da yazıldı, ve koşu 38'den itibaren Koşu 2'de sürdü.)*
...
# Koşu 2 — 18 Ağustos *(o zamanki adıyla "v3")*

**Tarih:** 2026-08-18 · **Branch:** `fix/mira`
**Kaynak:** [test bulguları](../research/2026-08-18-queenagent-test-bulgulari.md) — kullanıcının
elle turundan çıkan 15 bulgu; her bulgu bir madde. Numaralar Koşu 1'den devam eder.
...
- **Ne çalışır:** VS Code davranışı *(kullanıcı kararı, 19 Ağustos)*. Ray **her genişlikte sağda
  kalır** — Koşu 1 Madde 33'ün "1000px altında ray sohbetin altına iner" kuralı düşer. Kenarından
...
(38-52 bitince, Koşu 1 Madde 35'in turu bu değişikliklerle birlikte koşulur).
