...
andan sonra kimlik onlardır. Sebebi yaşanarak bulundu: belge bir gün içinde **iki kez** yeniden
numaralandı *(251–252, sonra 255–269, sonra 262–276)* — v6 aynı dalda koşarken madde eklemeye devam
etti ve her seferinde seçtiğimiz aralığı aldı; üçüncü çakışmada v6'nın 281'i bu belgenin 281'iyle
aynı numaraya oturdu. Koşmayan bir belgenin koşan bir sayaçtan numara alması buydu. **Bunun kuralı
...
**Bu koşu kullanıcıdan hiçbir şey beklemiyor.** Bir ara 15 için REF2VA'ya konmuş bir Export (API)
dosyası istenecekti — video ve ses referansının `timeline_data`'da hangi alanlarla yazıldığı
bilinmiyordu. **Node'un kaynağı okununca gerek kalmadı** *(21 Eylül)*; alanlar 15'in satırında,
adlarıyla duruyor.

## Referansla video üretiminin kararları

*(Kullanıcı, 21 Eylül — "task olarak referans video üretimi eklemek istiyorum".)* 7–15 bu kararları
uyguluyor.
...
- **Kart fotoğrafla doğmaz, fotoğraf arkadan gelir.** Video indiğinde ilk karesi çıkarılıp kartın
  fotoğraf yuvasına yazılır *(madde 6)* — galeride hızlı dolaşmak için, çünkü video yüklemek yavaş.
